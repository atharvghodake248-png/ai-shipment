        ...
        >
          <div className="flex items-center gap-2 overflow-hidden">
            ...
            <div className="flex flex-col items-start overflow-hidden">
              <span className="truncate text-sm font-medium text-white">{currentOrg?.name || 'Select organization'}</span>
              {currentOrg && (
      ...
      <PopoverContent className="w-[240px] p-0 bg-zinc-950 border-zinc-800">
        <Command className="bg-zinc-950">
          ...
          <CommandList>
            ...
            <CommandGroup heading="Organizations" className="text-zinc-500 [&_[cmdk-group-heading]]:text-zinc-500 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-semibold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-widest">
            ...
            <CommandGroup>
              <CommandItem onSelect={() => setOpen(false)} className="cursor-pointer text-zinc-300 aria-selected:bg-zinc-800 aria-selected:text-white rounded-lg">
